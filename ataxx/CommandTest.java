...
public class CommandTest {
    ...
    @Test public void testMANUAL() {
        ...
        check("     manual      blue     ", MANUAL, "blue");
        checkError("manual purple");
        checkError("manual");
        checkError("auto blue gud");
    }

    @Test public void testLOAD() {
        check("load myTest.inp", LOAD, "myTest.inp");
        check("load myTest.txt", LOAD, "myTest.txt");
        check("load myTest", LOAD, "myTest");
    }
